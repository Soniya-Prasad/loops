...
// Custom code by Kamal for sending webform mail with cc
function seven_webform_mail_headers($variables) {

    $headers = array(
      'X-Mailer' => 'Drupal Webform (PHP/' . phpversion() . ')',
    );

    $headers['CC'] = 'letters@youngtimes.com';
    $headers['BCC'] = 'wasim@khaleejtimes.com';
